...
-->    
	<div class="balance" v-if="selectedToken">
        ...
        <p>
          Your ETH: <span>{{ currentBalance }}<img src="https://zkbitcoin.org/img/ethereum.png" alt="ethereum" style="width: 15px; height: 15px;" /> {{ selectedToken.symbol }}</span>
        </p>
...
<h2>Your Unstaked and Staked Tokens are worth a total {{ (parseInt(ReservesTotal)/1e8* (parseInt(greetingStakeBalance)+parseInt(MaxsliderValue2)) / greetingLPTotal).toFixed(8) }}  <img src="https://zkbitcoin.org/img/0xbitcoin.png" alt="0xBitcoin" style="width: 25px; height: 25px;" />0xBTC and {{  (parseInt(ReservesTotal2)/1e18* (parseInt(greetingStakeBalance)+parseInt(MaxsliderValue2)) / greetingLPTotal) }} <img src="https://zkbitcoin.org/img/zkBitcoin.png" alt="0xBitcoin" style="width: 25px; height: 25px;" />zkBTC</h2>
<h1>Depositing</h1>
...
<h2>Your Staked Tokens are worth {{ (parseInt(ReservesTotal)/1e8* greetingStakeBalance / greetingLPTotal).toFixed(8) }} <img src="https://zkbitcoin.org/img/0xbitcoin.png" alt="0xBitcoin" style="width: 25px; height: 25px;" /> 0xBTC and {{  (parseInt(ReservesTotal2)/1e18* greetingStakeBalance / greetingLPTotal) }} <img src="https://zkbitcoin.org/img/zkBitcoin.png" alt="0xBitcoin" style="width: 25px; height: 25px;" />zkBTC </h2>
